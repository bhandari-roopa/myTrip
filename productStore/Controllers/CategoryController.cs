...
namespace productStore.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "cat_id,cat_name")] tbl_category tbl_category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "cat_id,cat_name")] tbl_category tbl_category)
        {
            if (ModelState.IsValid)
            {
